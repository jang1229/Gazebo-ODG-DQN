import random
import numpy as np
#from tensorflow.python.keras.models import Sequential, optimizers
#from tensorflow.python.keras.models import Dense, Activation, LeakyReLU, Dropout
#from tensorflow.python.keras.layers import Dense, Activation, LeakyReLU, Dropout
    ...
    def createRegularizedModel(self, inputs, outputs, hiddenLayers, activationType, learningRate):
        ...
        if len(hiddenLayers) == 0:
            ...
            if regularizationFactor > 0:
                model.add(Dense(hiddenLayers[0], input_shape=(self.input_size,), kernel_initializer='lecun_uniform', W_regularizer=l2(regularizationFactor),bias=True))
            else:
            ...
            model.add(Activation("linear"))
        optimizer = optimizers.RMSprop(lr=learningRate, rho=0.9, epsilon=1e-06,decay=0.0)
