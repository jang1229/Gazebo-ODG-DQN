...
if __name__ == '__main__':
    rospy.init_node('ODG_DQN_test', anonymous=True)
    ...
    if not continue_execution:
        ...
        #with open("/need/here/odg/1927.json") as outfile:
        #with open("/home/sun/Desktop/odg_dgq_4point_test/3290.json") as outfile: # odg_dqn_4point_test 6/02
        with open("/home/sun/path/Distance/TEST2/500.json") as outfile:  # odg max dqn test 6/14
        ...
        #deepQ.loadWeights("/need/here/odg/1927.h5")
        deepQ.loadWeights("/home/sun/path/Distance/TEST2/500.h5")
