    ...
    def step(self, action):
        ...
        while data is None:
            try:
                ...
                tptpt = rospy.wait_for_message('/pf/pose/odom', Odometry, timeout=5)
        ...
        xlist[episode_step] = tptpt.pose.pose.position.x
        ylist[episode_step] = tptpt.pose.pose.position.y
        point[0]=tptpt.pose.pose.position.x
        point[1]=tptpt.pose.pose.position.y
