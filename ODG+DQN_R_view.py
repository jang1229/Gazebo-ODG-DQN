...
def path_call():
    ...
    epoch=1500
    list_file = open("/home/sun/path/re_path/"+str(epoch)+"_Accuracy_DQN_R.txt", 'r').read().split(',')
#    list_file = open("/home/sun/path/re_path/"test_1_epoch_6400_Accuracy_DQN", 'r').read().split(',')
  ...
  #  print list_file  #dqn ok Time: 6:48:53
    ...
    list_file2 = open("/home/sun/path/reward_dqn/"+str(epoch)+"_rewrad_DQN_R.txt", 'r').read().split(',')
    ...
    list_file3 = open("/home/sun/path/Distance/" + str(epoch) + "_Distance_DQN_R.txt", 'r').read().split(',')
    #    list_file = open("/home/sun/path/re_path/"test_1_epoch_6400_Accuracy_DQN", 'r').read().split(',')
    ...
    list_file4 = open("/home/sun/path/Distance/step" + str(epoch) + "_step_DQN_R.txt", 'r').read().split(',')
    for i in range(step):
    ...
    list_file5 = open("/home/sun/path/speed_time/speed/" + str(epoch) + "_speed_DQN_R.txt", 'r').read().split(',')
    #    list_file = open("/home/sun/path/re_path/"test_1_epoch_6400_Accuracy_DQN", 'r').read().split(',')
    ...
    list_file6 = open("/home/sun/path/speed_time/time/" + str(epoch) + "_time_DQN_R.txt", 'r').read().split(',')
    for i in range(step):
