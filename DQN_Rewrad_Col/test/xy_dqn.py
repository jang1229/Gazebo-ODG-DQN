...
class env():
    ...
    def __init__(self):
        ...
        #self.xy = rospy.Publisher('/vesc/odom', Odometry, queue_size=1)
...
##### dqn
    ...
    def step(self, action):
        ...
        go = Odometry()
        xydata = rospy.wait_for_message('/vesc/odom', Odometry, timeout=5)
        print xydata
        print go.pose.pose.position.x
        print go.pose.pose.position.y
        state = [go.pose.pose.position.x, go.pose.pose.position.y]
    ...
    def reset(self):
        ...
        go = Odometry()
        #xydata = rospy.wait_for_message('/vesc/odom', Odometry, timeout=10)
        #print xydata
        print go.pose.pose.position.x
        print go.pose.pose.position.y
        state = [go.pose.pose.position.x, go.pose.pose.position.y]
